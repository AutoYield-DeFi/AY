                ...
                return (
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-background/50 border border-border/20 hover:border-primary/20 hover:bg-background transition-all duration-200">
                    <div className="flex items-center gap-3">
                      <div className={`flex items-center justify-center h-10 w-10 rounded-full ${isDeposit ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'} shrink-0`}>
                        {isDeposit ? (
                    ...
                    <div className="text-right">
                      <p className={`font-medium ${isDeposit ? 'text-green-500' : 'text-red-500'}`}>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 mt-1">
                  ...
                  <p className={`text-sm ${valueChange >= 0 ? 'text-green-500' : 'text-red-500'} flex items-center gap-1`}>
              ...
              <div className="pt-4 border-t border-border/30">
                <p className="text-sm text-muted-foreground mb-2">Top Performing Assets</p>
